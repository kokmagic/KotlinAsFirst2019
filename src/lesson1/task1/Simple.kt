 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = (initial + initial * percent / 100.0) + ((initial + initial * percent / 100.0) * percent / 100.0) +
        (((initial + initial * percent / 100.0) + ((initial + initial * percent / 100.0) * percent / 100.0)) * percent / 100.0)
